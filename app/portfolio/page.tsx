...
export const metadata: Metadata = {
  ...
  description: 'Explore our portfolio of products: VitalWall, VoiceCommit, and BlackOpsCenter',
};
          ...
          >
            <div className="flex-1">
              <div className="mb-4">
                ...
                <p className="text-sm text-gray-500 uppercase tracking-wide">{product.tagline}</p>
              </div>
